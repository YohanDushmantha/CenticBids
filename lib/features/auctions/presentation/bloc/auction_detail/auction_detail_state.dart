...
class AuctionDetailInitial extends AuctionDetailState {
  AuctionDetailInitial({@required AuctionItem auctionItem})
      : super(auctionItem: auctionItem);
  @override
  List<Object> get props => [];
}

class Loading extends AuctionDetailState {
  Loading({@required AuctionItem auctionItem})
      : super(auctionItem: auctionItem);
  @override
  List<Object> get props => [];
}
...
class Error extends AuctionDetailState {
  ...
  Error({@required AuctionItem auctionItem, this.runtimeError})
      : super(auctionItem: auctionItem);
...
class AuctionLoaded extends AuctionDetailState {
  AuctionLoaded({@required AuctionItem auctionItem})
      : super(auctionItem: auctionItem);
  @override
  List<Object> get props => [];
}
