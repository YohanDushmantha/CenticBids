...
class AuctionsRepositoryImpl extends AuctionsRepository{
  ...
  @override
  Future<Either<Failure, List<DocumentSnapshot>>> fetchAuctions(fetchAuctionsUsecase.Params params) async {
    try{
  ...
  @override
  Future<Either<Failure, AuctionItem>> fetchAuction(fetchAuctionUsecase.Params params) async{
    try{
